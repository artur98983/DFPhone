...
def main_menu():
        os.system("clear")
        print("""  ____  _____ ____  _                      ____    ___   """)
        print(""" |  _ \|  ___|  _ \| |__   ___  _ __   ___|___ \  / _ \  """)
        print(""" | | | | |_  | |_) | '_ \ / _ \| '_ \ / _ \ __) || | | | """)
        print(""" | |_| |  _| |  __/| | | | (_) | | | |  __// __/ | |_| | """)
        print(""" |____/|_|   |_|   |_| |_|\___/|_| |_|\___|_____(_)___/  """)
        print("""                                                         """)
        print(" > Добро пожаловать в DFphone v2.0")
        print("    > Разработчик - @batyarimskiy1")
        print("\n")
        print("        [1] - Поиск AVITO")
        print("         Поиск обьявлений на AVITO")
        print("")
        print("        [2] - Поиск GETCONTACT")
        print("         Поиск в базе GETCONTACT")
        print("")
        print("        [3] - Поиск STANDART")
        print("         Поиск стандартных данных")
        print("")
        print("        [4] - Поиск TELEGRAM")
        print("         Поиск аккаунта TELEGRAM\n         (в разработке)")
        print("")
        print('\n')
